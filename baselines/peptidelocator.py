...
# PEPTIDE_LOCATOR_PORTER_MODELS_DIR = pjoin(PEPTIDE_LOCATOR_BIN_DIR, "BlastFiles")
# PEPTIDE_LOCATOR_IUPRED_DIR = pjoin(PEPTIDE_LOCATOR_BIN_DIR, "iupred")

# PEPTIDE_LOCATOR_PORTER_PLUSS_MODELS_DIR = pjoin(PEPTIDE_LOCATOR_BIN_DIR, "PorterModels")
# PEPTIDE_LOCATOR_PORTER_PLUSS_FOLDER = pjoin(PEPTIDE_LOCATOR_BIN_DIR, "Porter_Models")
...
BIN_DIR = "/novo/users/fegt/random/in-silico-peptidomics/baselines/"
PEPTIDE_LOCATOR_BIN_DIR = pjoin(BIN_DIR, "PeptideLocator")
...
def get_preds():
    import pandas as pd
    data = pd.read_csv('data/uniprot_labeled_data_cv_5_60/labeled_sequences.csv')
    ...
    for idx, row in tqdm(data.iterrows(), total=len(data)):
        ...
        data.to_csv('results/peptidelocator_predictions.csv')
